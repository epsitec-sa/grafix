...
#elif defined(AGG_BGR24_GAMMA)

#include "agg_pixfmt_rgb24_gamma.h"
#define pix_format agg::pix_format_bgr24
typedef agg::pixfmt_bgr24_gamma pixfmt;
typedef agg::rgba8 color_type;
typedef agg::order_bgr24 component_order;

#elif defined(AGG_RGB24_GAMMA)

#include "agg_pixfmt_rgb24_gamma.h"
#define pix_format agg::pix_format_rgb24
typedef agg::pixfmt_rgb24_gamma pixfmt;
typedef agg::rgba8 color_type;
typedef agg::order_rgb24 component_order;
...
#elif defined(AGG_BGRA32_PRE)

#include "agg_pixfmt_rgba32_pre.h"
#define pix_format agg::pix_format_bgra32
typedef agg::pixfmt_bgra32_pre pixfmt;
typedef agg::rgba8_pre color_type;
typedef agg::order_bgra32 component_order;

#elif defined(AGG_RGBA32_PRE)
...
#elif defined(AGG_ARGB32_PRE)

#include "agg_pixfmt_rgba32_pre.h"
#define pix_format agg::pix_format_argb32
typedef agg::pixfmt_argb32_pre pixfmt;
typedef agg::rgba8_pre color_type;
typedef agg::order_argb32 component_order;

#elif defined(AGG_ABGR32_PRE)

#include "agg_pixfmt_rgba32_pre.h"
#define pix_format agg::pix_format_abgr32
typedef agg::pixfmt_abgr32_pre pixfmt;
typedef agg::rgba8_pre color_type;
typedef agg::order_argb32 component_order;

#elif defined(AGG_BGRA32_PLAIN)

#include "agg_pixfmt_rgba32_plain.h"
#define pix_format agg::pix_format_bgra32
typedef agg::pixfmt_bgra32_plain pixfmt;
typedef agg::rgba8 color_type;
typedef agg::order_bgra32 component_order;

#elif defined(AGG_RGBA32_PLAIN)
...
#elif defined(AGG_ARGB32_PLAIN)

#include "agg_pixfmt_rgba32_plain.h"
#define pix_format agg::pix_format_argb32
typedef agg::pixfmt_argb32_plain pixfmt;
typedef agg::rgba8 color_type;
typedef agg::order_argb32 component_order;

#elif defined(AGG_ABGR32_PLAIN)

#include "agg_pixfmt_rgba32_plain.h"
#define pix_format agg::pix_format_abgr32
typedef agg::pixfmt_abgr32_plain pixfmt;
typedef agg::rgba8 color_type;
typedef agg::order_argb32 component_order;
