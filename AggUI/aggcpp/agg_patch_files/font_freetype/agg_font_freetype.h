...
namespace agg
{
    ...
    public:
        ...
        // this does the same thing as prepare_glyph
        // but takes a glyph index instead of a char code
        bool            prepare_glyph_from_index(unsigned glyph_index);
    ...
    // PATCHED: allow inheriting classes to access internal data
    protected:
