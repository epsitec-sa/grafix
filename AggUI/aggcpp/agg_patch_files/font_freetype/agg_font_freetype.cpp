...
namespace agg
{
    ...
    {   
        ...
        FT_Vector*  point;
        FT_Vector*  limit;
        // PATCHED: API change in freetype
        unsigned char*       tags;
    ...
    {
        unsigned index = FT_Get_Char_Index(m_cur_face, glyph_code);
        return prepare_glyph_from_index(index);
    }

    // PATCHED:     add prepare_glyph_from_index
    bool font_engine_freetype_base::prepare_glyph_from_index(unsigned glyph_index)
    {
